...
import { Delegate } from 'src/interfaces/delegate.interface';
...
export abstract class CrudService<D extends Delegate, T extends CrudMapType> {
  ...
  public async findManyPaginate(
    ...
    if (Array.isArray(args.orderBy)) {
      args.orderBy.push({ id: direction });
    } else {
      args.orderBy = [args.orderBy, { id: direction }];
    }
